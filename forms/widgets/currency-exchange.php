...
$list_units = d4p_units()->get_currency_types();
...
<table>
    <tbody>
        <tr>
            <td class="cell-left">
                <label for="<?php echo $this->get_field_id('units'); ?>"><?php _e("Exchange Rate to Display", "gd-clever-widgets"); ?>:</label>
            ...
            <td class="cell-right">
                ...
                <p>
                    <?php _e("Select one or more exchange rate types to display in the widget. If only one type is selected, rendered widget output will have selection box hidden.", "gd-clever-widgets"); ?>
                </p>
            </td>
        </tr>
        <tr>
