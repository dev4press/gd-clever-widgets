...
class d4pclwWidget_Currency_Exchange extends d4p_widget_core {
    public $widget_base = 'd4p_clw_currency';
    ...
    public function __construct($id_base = false, $name = '', $widget_options = array(), $control_options = array()) {
        $this->widget_description = __("Convert currencies using different rates sources.", "gd-clever-widgets");
        $this->widget_name = __("Clever", "gd-clever-widgets").': '.__("Currency Exchange", "gd-clever-widgets");
    ...
    public function form($instance) {
        ...
        $_tabs = array(
            ...
            'content' => array('name' => __("Content", "gd-clever-widgets"), 'include' => array('currency-exchange')),
    ...
    public function render($results, $instance) {
        ...
        include(GDCLW_PATH.'forms/render/currency-exchange.php');
